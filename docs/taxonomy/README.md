...
- [Taxonomy-to-FMO Crosswalk Draft v0.1](M1_TAXONOMY_TO_FMO_CROSSWALK_DRAFT_v0.1.md) preserves an unregistered mapping proposal separately from the exact registered v1 subject bytes. It does not amend or supersede either subject, report a result, or create evidence.
