...
A pre-result repair package under [`superseding/pre-result-metadata-intake-v2/`](superseding/pre-result-metadata-intake-v2/) records version-2 obligations for blockers B2–B6 and the external intake-digest contract. The superseding freeze package under [`superseding/study-record-v2/`](superseding/study-record-v2/) freezes and registers `LCMRP-FSTUDYREC-0001-M1-TAXONOMY@2` for those metadata repairs. Residual human-contributor blocker **B1 remains open**; freeze is **not** execution authority. See [pre-result repair review](../../../reviews/M1_TAXONOMY_PRE_RESULT_REPAIR_PACKAGE_2026-07-22.md) and [v2 freeze review](../../../reviews/M1_TAXONOMY_STUDY_RECORD_V2_FREEZE_2026-07-22.md).
