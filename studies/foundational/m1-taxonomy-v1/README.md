...
A pre-result repair package under [`superseding/pre-result-metadata-intake-v2/`](superseding/pre-result-metadata-intake-v2/) records version-2 obligations for blockers B2–B6 and the external intake-digest contract. Version-2 freeze materials live under [`superseding/study-record-v2/`](superseding/study-record-v2/). Version-3 under [`superseding/study-record-v3/`](superseding/study-record-v3/) freezes a **solo-human + AI-tooling** method supersession for truthful solo research (exploratory; AI is not final coder; multi-human staffing abandoned as unexecutable here). Live intake and coding remain separate. See [pre-result repair](../../../reviews/M1_TAXONOMY_PRE_RESULT_REPAIR_PACKAGE_2026-07-22.md), [v2 freeze](../../../reviews/M1_TAXONOMY_STUDY_RECORD_V2_FREEZE_2026-07-22.md), and [solo+AI v3](../../../reviews/M1_TAXONOMY_SOLO_AI_METHOD_V3_2026-07-22.md).
