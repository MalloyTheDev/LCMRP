...
REQUIRED_PATHS = (
    ...
    "docs/taxonomy/M1_TAXONOMY_TO_FMO_CROSSWALK_DRAFT_v0.1.md",
    ...
    "studies/README.md",
    "studies/foundational/m1-taxonomy-v1/protocol-v1.md",
    "studies/foundational/m1-taxonomy-v1/freeze-attestation.json",
    "studies/foundational/m1-formal-model-v1/protocol-v1.md",
    "studies/foundational/m1-formal-model-v1/freeze-attestation.json",
    ...
    "reviews/M1_FORMAL_MODEL_EXECUTION_READINESS_2026-07-21.md",
